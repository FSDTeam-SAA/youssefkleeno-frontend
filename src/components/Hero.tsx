    ...
    <div>
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('/herobg.png')`,
          }}
        />
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8  text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-start items-center">
            <Button size="lg" className="bg-[#499FC0] hover:bg-[#499FC0]/90 text-white px-8 py-3 text-md w-full sm:w-auto">
